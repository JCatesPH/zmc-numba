...
MC = ZMCIntegral.MCintegral(gauss_func,[[-1,1],[-1,1],[-1,1],[-1,1]])
...
print('======================================================================')
print('======================================================================')
print('Calculating the following function\'s integral: [xi = (-1,1)]')
print('math.exp(-1/(2*s**2)*(x[0]**2+x[1]**2+x[2]**2+x[3]**2))/(math.sqrt(2*3.14)*s)**4')
print('======================================================================')

print('\n Optimizing sigma_multiplication:')
print('======================================================================')
